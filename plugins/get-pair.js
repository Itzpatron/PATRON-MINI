...
cmd({
    ...
    react: "✅",
    desc: "Get pairing code for ᴘᴀᴛʀᴏɴ-ᴍɪɴɪ bot",
    category: "misc",
    use: ".pair 254111***",
    filename: __filename
    ...
    try {
        ...
        const response = await axios.get(`https://patron-mini.up.railway.app/code?number=${encodeURIComponent(phoneNumber)}`);
...
cmd({
    ...
    react: "📉",
    desc: "Get pairing code for PATROM-MINI bot",
    category: "misc",
    use: ".pair 234XXXXXX",
    filename: __filename
}, async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, senderNumber, reply }) => {
